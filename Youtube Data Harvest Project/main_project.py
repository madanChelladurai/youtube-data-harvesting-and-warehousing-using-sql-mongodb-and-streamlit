...
icon = Image.open("C:/Users/MADAN/OneDrive/Youtube_logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Madan Chelladurai",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Madan Chelladurai!*"""})

# CREATING OPTION MENU
with st.sidebar:
    selected = option_menu(None, ["Home","Extract & Transform","View"], 
                           icons=["house-door-fill","tstrllit ools","card-text"],
                           default_index=0,
